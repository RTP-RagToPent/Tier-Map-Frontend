      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            {/* Twitter/X */}
            <Button onClick={handleShareTwitter} className="w-full bg-black hover:bg-gray-800">
              <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* 画像ダウンロード（未実装） */}
            <Button onClick={handleDownloadImage} variant="outline" className="w-full" disabled>
              画像として保存（実装予定）
            </Button>
          </div>
